<template>
  <div>
    <div>
      <my-account-list-header v-on:keyup.13="submits()" :reloadAccountList="reloadAccountList"></my-account-list-header>
      <div class="container full">
        <div class="course_list">
          <my-account-view :courseName="courseName"
                      ></my-account-view>
        </div>
      </div>
    </div>
...
<script>
  import myAccountView from '~/components/myAccount/MyAccountView.vue'
  import myAccountListHeader from '~/components/myAccount/Header.vue'
