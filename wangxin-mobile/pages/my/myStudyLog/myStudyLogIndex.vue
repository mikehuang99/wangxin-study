<template>
  <div>
    <div>
      <my-study-log-list-header v-on:keyup.13="submits()" :reloadStudyLogList="reloadStudyLogList"></my-study-log-list-header>
      <div class="container full">
        <div class="course_list">
          <my-study-log-list  :courseName="courseName"
                      ></my-study-log-list>
        </div>
      </div>
    </div>
...
<script>
  import myStudyLogList from '~/components/myStudyLog/myStudyLogList.vue'
  import myStudyLogListHeader from '~/components/myStudyLog/myStudyLogListHeader.vue'
