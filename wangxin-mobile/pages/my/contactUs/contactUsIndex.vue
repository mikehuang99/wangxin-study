<template>
  <div>
    <div>
      <contact-us-list-header v-on:keyup.13="submits()" :reloadAccountList="reloadAccountList"></contact-us-list-header>
      <div class="container full">
        <div class="course_list">
          <contact-us-view :courseName="courseName"
                      ></contact-us-view>
        </div>
      </div>
    </div>
...
<script>
  import contactUsView from '~/components/contactUs/ContactUsView.vue'
  import contactUsListHeader from '~/components/contactUs/Header.vue'
