<template>
  <div>
    <div>
      <my-point-list-header v-on:keyup.13="submits()" :reloadPointList="reloadPointList"></my-point-list-header>
      <div class="container full">
        <div class="course_list">
          <my-point-list :courseName="courseName"
                      ></my-point-list>
        </div>
      </div>
    </div>
...
<script>
  import myPointList from '~/components/myPoint/MyPointList.vue'
  import myPointListHeader from '~/components/myPoint/Header.vue'
