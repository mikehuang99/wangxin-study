<template>
  <div>
    <div>
      <my-exam-management-list-header v-on:keyup.13="submits()" :reloadOrderList="reloadOrderList"></my-exam-management-list-header>
      <div class="container full">
        <div class="course_list">
          <my-exam-management-list :title="title"
                      ></my-exam-management-list>
        </div>
      </div>
    </div>
  </div>
...
<script>
  import myExamManagementList from '~/components/myExamManagement/myExamManagementList.vue'
  import myExamManagementListHeader from '~/components/myExamManagement/myExamManagementListHeader.vue'
  ...
  export default {
    ...
    components: {
        myExamManagementList,
        myExamManagementListHeader
    },
    computed: {
