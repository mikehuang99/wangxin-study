<template>
  <div>
    <div>
      <my-order-list-header v-on:keyup.13="submits()" :reloadOrderList="reloadOrderList"></my-order-list-header>
      <div class="container full">
        <div class="course_list">
          <my-order-list :courseName="courseName"
                      ></my-order-list>
        </div>
      </div>
    </div>
...
<script>
  import myOrderList from '~/components/myOrder/myOrderList.vue'
  import myOrderListHeader from '~/components/myOrder/myOrderListHeader.vue'
