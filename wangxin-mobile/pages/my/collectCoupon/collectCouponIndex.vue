<template>
  <div>
    <div>
      <h-header v-on:keyup.13="submits()" :reloadCouponList="reloadCouponList"></h-header>
      <div class="container full">
        <div class="course_list">
          <collect-coupon :courseName="courseName"
                      ></collect-coupon>
        </div>
      </div>
    </div>
...
<script>
  import collectCoupon from '~/components/collectCoupon/CollectCoupon.vue'
  import hHeader from '~/components/collectCoupon/Header.vue'
