  ...
  <div class="fix_bottom_contain">
      <div class="bottom_btn">
        <a class="count_d" :class="{after: true}">
          <span @click="goQuestion('last')" style="color: #333333;-webkit-border-radius: 5px;-moz-border-radius: 5px;border-radius: 5px;">
          ...
          <span>&nbsp;</span>
          <span @click="goQuestion('next')" style="color: #333333;-webkit-border-radius: 5px;-moz-border-radius: 5px;border-radius: 5px;">
