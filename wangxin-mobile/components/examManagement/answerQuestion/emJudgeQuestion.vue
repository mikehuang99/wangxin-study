    ...
    export default {
        ...
        mounted() {
            ...
            if(lastAnswer!=null){
                ...
                if(isReview!=1) {
                    document.getElementById("judge_" + lastAnswer).style = 'background: grey url(\'/wxmobile/img/icon_red_ok.png\')no-repeat 0.8rem 0.8rem;background-size: 1.8rem';
                }else{
        ...
        methods:{
            clickItem(item){
                ...
                document.getElementById("judge_"+item).style = 'background: grey url(\'/wxmobile/img/icon_red_ok.png\')no-repeat 0.8rem 0.8rem;background-size: 1.8rem';
                setTimeout(() => {
