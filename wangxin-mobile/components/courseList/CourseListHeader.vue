  ...
  <header id="header" class="header">
    ...
    <div class="header_search">
      <div class="drop_down_list">
        <span data-role="select_txt" class="select_txt">名称</span>
      </div>
      <div class="header_search_area">
        <input v-model.trim="courseName" v-on:keyup.13="submit()" placeholder="搜索课程" class="header_search_txt">
        <div class="reset_all_condition" @click="reload()">
          <!--
          <img v-if="!reloadFlag" style="width: 22px;height: 22px" src="/wxmobile/img/wxImg/reload.png">
          <img v-if="reloadFlag" style="width: 22px;height: 22px" src="/wxmobile/img/wxImg/reloading.png">
          -->
...
export default {
  ...
  mounted () {
    ...
    watch: {
        ...
        courseName() {
            this.$parent.reloadCourseList(this.courseName);
        }
    },
  methods: {
      reload(){
