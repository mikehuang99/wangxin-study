<template>
  <div>
      ...
      <div>
       <div class="account_item">
         ...
         <div class="account_item_right">
           <input type="text" disabled="disabled" v-model="userInfo.mobile"/>
         </div>
       </div>
        <div class="account_item">
          <div class="account_item_left">
          ...
          <div class="account_item_right">
            <input type="text" :disabled="!isUpdate" v-model="userInfo.nickname"/>
          </div>
        </div>
        <div class="account_item">
          <div class="account_item_left">
          ...
          <div class="account_item_right">
            <input type="text" :disabled="!isUpdate" v-model="userInfo.realName"/>
          </div>
        </div>
        <div class="account_item">
          <div class="account_item_left">
          ...
          <div class="account_item_right">
            <input type="text" :disabled="!isUpdate" v-model="userInfo.identityCardNo"/>
          </div>
        </div>
        <div class="account_item">
          <div class="account_item_left">
          ...
          <div class="account_item_right">
            <input type="text" :disabled="!isUpdate" v-model="userInfo.age"/>
          </div>
        </div>
        <div class="account_item">
          <div class="account_item_left">
          ...
          <div class="account_item_right">
            <select name="sex" id="sex" :disabled="!isUpdate" v-model="userInfo.sex">
    ...
    <div style="text-align: center;margin-top: 30px">
      <div class="add_study_card_btn_box" v-if="isUpdate" @click="toCancelUpdateUserInfo">取消</div>
      <div class="add_study_card_btn_box" v-if="!isUpdate"  @click="toUpdateUserInfo">修改</div>
      <div class="add_study_card_btn_box" v-if="isUpdate"  @click="updateUserInfo">确定</div>
    </div>
    <div style="color: orangered;margin-top: 20px;font-size: 14px;padding-left: 10px;padding-right: 10px">
      提示："真实姓名"和"身份证号码" 一经填写提交，后续不能再修改。如需修改，请联系管理员
    </div>
