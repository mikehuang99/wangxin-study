<template>
  <header class="header" :class="[this.backgroundColor ? 'fff' : '' ]">
    ...
    <span style="font-size: 18px;font-weight: bold;color: white">积分记录</span>
    <div style="width: 30%;height: 90%;position: absolute;right: 10px;
    color: #ffffff;font-size: 14px;top: 12px;text-decoration: underline" @click="goPointIndex">用点券兑换积分</div>
  </header>
</template>
<script>
export default {
