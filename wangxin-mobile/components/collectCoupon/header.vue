<template>
  <header class="header" :class="[this.backgroundColor ? 'fff' : '' ]">
    ...
    <span style="font-size: 18px;font-weight: bold;color: white">领取优惠券</span>
    <div style="width: 25%;height: 90%;position: absolute;right: 10px;
    color: #ffffff;font-size: 14px;top: 12px;text-decoration: underline" @click="goMyCouponList">我的优惠券</div>
  </header>
</template>
<script>
export default {
