  ...
  <div>
    ...
    <div class="pay_box font_14" v-if="payStep === 0">
      <div class="clearfix box_title b_245">
        ...
        <span class="fr iconfont close" @click="close()">关闭</span>
      </div>
    ...
    <div class="paymodal payrun" v-else-if="payStep === 2">
      ...
      <div class="modal_body">
        ...
        <div class="center">
          <router-link class="solid_btn" v-if="info.courseSubject == 1" :to="{name: 'courselDetail', params: {id: info.id}}">立即学习</router-link>
          <router-link class="solid_btn" v-else-if="info.courseSubject == 2" :to="{name: 'liveDetail', params: {id: info.id}}">立即学习</router-link>
          <router-link class="solid_btn" v-else-if="info.courseSubject == 3" :to="{name: 'liveAndBunch', params: {id: info.id}}">立即学习</router-link>
  ...
  export default {
    ...
    methods: {
      ...
      submit () {
        ...
        that.order.courseSubject = that.info.courseSubject
