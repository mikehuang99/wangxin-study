      ...
      <div class="main_box">
        ...
        <div class="main_cont form">
          <div style="width: 100%;height: 30px;">
            ...
            <button type="primary" @click="submit($event)">导入多选题</button>
            <span href="" style="text-decoration: underline;color:#4169E1;cursor:pointer" @click="examQuestionImportTemplate">下载多选题导入模版</span>
          </div>
          <hr>
          <form action="" @submit="examQuestionSave">
            ...
            <div class="form_group">
              ...
              <div class="form_ctl">
                ...
                <strong>是否答案：</strong><input  type="checkbox" id="A" value="A" v-model="answers"  class="form_input_min_a">
              </div>
            </div>
            <div class="form_group">
              ...
              <div class="form_ctl">
                ...
                <strong>是否答案：</strong><input  type="checkbox" id="B" value="B" v-model="answers"  class="form_input_min_a">
              </div>
            </div>
            <div class="form_group">
              ...
              <div class="form_ctl">
                ...
                <strong>是否答案：</strong><input  type="checkbox" id="C" value="C" v-model="answers"  class="form_input_min_a">
              </div>
            </div>
            <div class="form_group">
              ...
              <div class="form_ctl">
                ...
                <strong>是否答案：</strong><input  type="checkbox" id="D" value="D" v-model="answers"  class="form_input_min_a">
              </div>
            </div>
            <div class="form_group">
              ...
              <div class="form_ctl">
                ...
                <strong>是否答案：</strong><input  type="checkbox" id="E" value="E" v-model="answers"  class="form_input_min_a">
              </div>
            </div>
            <div class="form_group">
              ...
              <div class="form_ctl">
                ...
                <strong>是否答案：</strong><input  type="checkbox" id="F" value="F" v-model="answers"  class="form_input_min_a">
              </div>
            </div>
            <div class="form_group">
              ...
              <div class="form_ctl">
                ...
                <strong>是否答案：</strong><input  type="checkbox" id="G" value="G" v-model="answers"  class="form_input_min_a">
              </div>
            </div>
            <div class="form_group">
              ...
              <div class="form_ctl">
                ...
                <strong>是否答案：</strong><input  type="checkbox" id="H" value="H" v-model="answers"  class="form_input_min_a">
              </div>
            </div>
            <div class="form_group">
              ...
              <div class="form_ctl">
                ...
                <input type="text"  class="form_input"  v-model="obj.answer"  disabled="disabled" placeholder="勾选答案将自动填充"/>
            ...
            getExamQuestion() {
                ...
                examQuestionView({id: this.$route.query.no}).then(res => {
                    ...
                    if (res.data.code === 200) {
                        ...
                        var i=0;
                        if(this.obj.answer.indexOf('A')!=-1){
                            this.answers[i]="A";
                            i++;
                        }
                        if(this.obj.answer.indexOf('B')!=-1){
                            this.answers[i]="B";
                            i++;
                        }
                        if(this.obj.answer.indexOf('C')!=-1){
                            this.answers[i]="C";
                            i++;
                        }
                        if(this.obj.answer.indexOf('D')!=-1){
                            this.answers[i]="D";
                            i++;
                        }
                        if(this.obj.answer.indexOf('E')!=-1){
                            this.answers[i]="E";
                            i++;
                        }
                        if(this.obj.answer.indexOf('F')!=-1){
                            this.answers[i]="F";
                            i++;
                        }
                        if(this.obj.answer.indexOf('G')!=-1){
                            this.answers[i]="G";
                            i++;
                        }
                        if(this.obj.answer.indexOf('H')!=-1){
                            this.answers[i]="H";
                        }
