      ...
      <div class="main_box">
        ...
        <div class="main_cont form">
          <div style="width: 100%;height: 30px;">
            ...
            <button type="primary" @click="submit($event)">导入填空题</button>
            <span href="" style="text-decoration: underline;color:#4169E1;cursor:pointer" @click="examQuestionImportTemplate">下载填空题导入模版</span>
          </div>
          <hr>
          <form action="" @submit="examQuestionSave">
            ...
            <div class="form_group">
              ...
              <div class="form_ctl">
                <input type="text" v-model="obj.questionTitle" class="form_input" @click="openDialog('questionTitle','题干  提示：填空题的空用 (_) 代替')" placeholder="请输入题干">
                <span style="color: red">提示：填空题的空用 (_) 代替</span>
              </div>
            </div>
            <div class="form_group">
              <div class="label">第一个空答案</div>
              <div class="form_ctl">
                <!--
                <input type="text" v-model="obj.itemA" class="form_input" @click="openDialog('itemA','第一个空答案')" placeholder="请输入第一个空答案">
                -->
                <input type="text" v-model="obj.itemA" class="form_input" placeholder="请输入第一个空答案">
                <span style="color: red">警告：有"空"才能填写答案，没有"空"不要填，下同</span>
              </div>
            </div>
            <div class="form_group">
              <div class="label">第二个空答案</div>
              <div class="form_ctl">
                <!--
                <input type="text" v-model="obj.itemB" class="form_input" @click="openDialog('itemB','第二个空答案')" placeholder="请输入第二个空答案">
                -->
                <input type="text" v-model="obj.itemB" class="form_input" placeholder="请输入第二个空答案">
              </div>
            </div>
            <div class="form_group">
              <div class="label">第三个空答案</div>
              <div class="form_ctl">
                <!--
                <input type="text" v-model="obj.itemC" class="form_input" @click="openDialog('itemC','第三个空答案')" placeholder="请输入第三个空答案">
                -->
                <input type="text" v-model="obj.itemC" class="form_input" placeholder="请输入第三个空答案">
              </div>
            </div>
            <div class="form_group">
              <div class="label">第四个空答案</div>
              <div class="form_ctl">
                <!--
                <input type="text" v-model="obj.itemD" class="form_input" @click="openDialog('itemD','第四个空答案')" placeholder="请输入第四个空答案">
                -->
                <input type="text" v-model="obj.itemD" class="form_input" placeholder="请输入第四个空答案">
              </div>
            </div>
            <div class="form_group">
              <div class="label">第五个空答案</div>
              <div class="form_ctl">
                <!--
                <input type="text" v-model="obj.itemE" class="form_input" @click="openDialog('itemE','第五个空答案')" placeholder="请输入第五个空答案">
                -->
                <input type="text" v-model="obj.itemE" class="form_input" placeholder="请输入第五个空答案">
              </div>
            </div>
            <div class="form_group">
              <div class="label">第六个空答案</div>
              <div class="form_ctl">
                <!--
                <input type="text" v-model="obj.itemF" class="form_input" @click="openDialog('itemF','第六个空答案')" placeholder="请输入第六个空答案">
                {{obj.itemFA}}-->
                <input type="text" v-model="obj.itemF" class="form_input" placeholder="请输入第六个空答案">
              </div>
            </div>
            <div class="form_group">
              <div class="label">第七个空答案</div>
              <div class="form_ctl">
                <!--
                <input type="text" v-model="obj.itemG" class="form_input" @click="openDialog('itemG','第七个空答案')" placeholder="请输入第七个空答案">
                -->
                <input type="text" v-model="obj.itemG" class="form_input" placeholder="请输入第七个空答案">
              </div>
            </div>
            <div class="form_group">
              <div class="label">第八个空答案</div>
              <div class="form_ctl">
                <!--
                <input type="text" v-model="obj.itemH" class="form_input" @click="openDialog('itemH','第八个空答案')" placeholder="请输入第八个空答案">
                -->
                <input type="text" v-model="obj.itemH" class="form_input" placeholder="请输入第八个空答案">
              </div>
            </div>
            <div class="form_group">
            ...
            getExamQuestion() {
                ...
                examQuestionView({id: this.$route.query.no}).then(res => {
                    ...
                    if (res.data.code === 200) {
                        ...
                        //this.editor2.txt.html(questionData.introduce);
                        this.obj = questionData;
