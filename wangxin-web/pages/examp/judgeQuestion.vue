      ...
      <div class="main_box">
        ...
        <div class="main_cont form">
          <div style="width: 100%;height: 30px;">
            ...
            <button type="primary" @click="submit($event)">导入判断题</button>
            <span href="" style="text-decoration: underline;color:#4169E1;cursor:pointer" @click="examQuestionImportTemplate">下载判断题导入模版</span>
          </div>
          <hr>
          <form action="" @submit="examQuestionSave">
            ...
            <div class="form_group">
              ...
              <div class="form_ctl">
                <strong>对：</strong><input  type="radio" id="a1" value="1" v-model="obj.answer" class="form_input_min_a">
                <strong>错：</strong><input  type="radio" id="a2" value="0" v-model="obj.answer" class="form_input_min_a">
              </div>
            </div>
            <div class="form_group">
...
<script>
    ...
    import {examQuestionImportTemplate,examQuestionImport,examQuestionSave,examQuestionUpdate,examQuestionView,infiniteCate, courseDetail, accessoryList} from '~/api/account/course.js'
