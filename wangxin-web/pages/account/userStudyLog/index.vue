<template>
  <div>
    ...
    <div class="person_body container account_cont clearfix">
      <y-side :type="'userStudyLog'"></y-side>
      <div class="main_box">
...
<script>
    ...
    import {userStudyLogListByStudentUserNo} from '~/api/user.js'
    ...
    export default {
        ...
        methods: {
            ...
            getUserStudyLogList(isStartFromFirstPage) {
                ...
                userStudyLogListByStudentUserNo(this.pda).then(res => {
                    let result = res.data
                    console.log(result)
                    console.log('course----')
