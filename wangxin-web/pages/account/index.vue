      ...
      <div class="main_box">
        ...
        <div class="main_cont form" v-if="isLogin">
          <form action="" @submit="userEducationInfUpdate">
            ...
            <div class="form_group">
              ...
              <div class="form_ctl">
                <input type="text" v-model="obj.realName" class="form_input" placeholder="请输入真实姓名">
                <span>真实姓名一经填写提交，后续不能再修改。如需修改，请联系管理员</span>
              </div>
            </div>
            <div class="form_group">
              <div class="label">身份证号码:</div>
              <div class="form_ctl">
                <input type="text" v-model="obj.identityCardNo" class="form_input" placeholder="请输入身份证号码">
                <span>身份证号码一经填写提交，后续不能再修改。如需修改，请联系管理员</span>
              </div>
            </div>
            <div class="form_group">
        ...
        <div class="main_cont form" v-else>
          ...
          <div class="form_group">
            <div class="label">真实姓名:</div>
            <div class="form_ctl">
              <div class="text">{{ obj.realName }}</div>
            </div>
          </div>
          <div class="form_group">
            <div class="label">身份证号码:</div>
            <div class="form_ctl">
              <div class="text">{{ obj.identityCardNo }}</div>
            </div>
          </div>
          <div class="form_group">
            <div class="label">年龄:</div>
