...
@Repository
public class FreshTopicDao extends BaseDao {

	public Page<FreshTopicVo> queryTopics(FreshTopicQ q) {
        ...
        sb.append("select q.* from topic q ");
        sb.append(" where 1=1 ");
    	...
    	*/
        ...
        List<FreshTopicVo> list = new ArrayList<FreshTopicVo>();
        for(Map<String, Object> map:pge.getList()){
        	...
        	FreshTopicVo vo = new FreshTopicVo();
        	ObjectMapUtil2.mapToObjModle(vo,mapHump);
        	list.add(vo);
        }
        
        Page<FreshTopicVo> pg = new Page<FreshTopicVo>();
