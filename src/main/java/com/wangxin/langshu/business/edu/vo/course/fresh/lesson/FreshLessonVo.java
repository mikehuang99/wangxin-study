...
public class FreshLessonVo  implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6064249149931024149L;
	...
	@ApiModelProperty(value = "时长", required = false)
    private String videoLengthReal;//时长	
	...
	@ApiModelProperty(value = "视频上传状态", required = false)
    private String videoOasUrl;//视频存储路径
