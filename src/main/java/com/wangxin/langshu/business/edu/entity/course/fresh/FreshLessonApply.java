...
@TableName(value ="lesson_apply")
public class FreshLessonApply extends Model<FreshLessonApply> implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7691246485450741484L;
