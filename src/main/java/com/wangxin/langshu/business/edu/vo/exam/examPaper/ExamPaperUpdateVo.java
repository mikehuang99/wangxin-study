...
public class ExamPaperUpdateVo  implements Serializable{
	/**
	 * 
	 */
	private static final long serialVersionUID = 6023682891022244160L;
	...
	@ApiModelProperty(value = "按章节比例出题内容", required = false)
	private List<Map<String, String>> detailByChapterList;//按章节比例出题内容
