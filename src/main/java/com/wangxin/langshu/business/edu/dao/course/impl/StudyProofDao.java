...
@Repository
public class StudyProofDao extends BaseDao {
	...
	public Page<StudyProofVo> queryStudyProofs(StudyProofQ q) {
        ...
        sb.append("select q.* from study_proof ");
        sb.append(" where 1=1 ");
        ...
        List<StudyProofVo> list = new ArrayList<StudyProofVo>();
        for(Map<String, Object> map:pge.getList()){
        	...
        	StudyProofVo vo = new StudyProofVo();
        	ObjectMapUtil2.mapToObjModle(vo,mapHump);
        	list.add(vo);
        }
        
        Page<StudyProofVo> pg = new Page<StudyProofVo>();
