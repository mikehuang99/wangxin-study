...
public class FreshCourseVo  implements Serializable{
	

	/**
	 * 
	 */
	private static final long serialVersionUID = 7327131472564606693L;
	...
	@ApiModelProperty(value = "是否已经被加到专区", required = false)
	private int isAddTopicCourse;//是否已经被加到专区
}
