...
@Repository
public class FreshCourseApplyDao extends BaseDao {
	...
	public Page<FreshCourseApplyVo> queryCourseApplys(FreshCourseApplyQ q) {
        ...
        sb.append("cs3.subject_name as subject_name3 from course_apply q ");
        ...
        sb.append(" where 1=1 and q.valid_value=1 ");
        ...
        List<FreshCourseApplyVo> list = new ArrayList<FreshCourseApplyVo>();
        for(Map<String, Object> map:pge.getList()){
        	...
        	FreshCourseApplyVo vo = new FreshCourseApplyVo();
        	ObjectMapUtil2.mapToObjModle(vo,mapHump);
        	list.add(vo);
        }
        
        Page<FreshCourseApplyVo> pg = new Page<FreshCourseApplyVo>();
	...
	public Page<FreshCourseApplyVo> queryPcBossCourseApplys(FreshCourseApplyQ q) {
    	...
    	sb.append(" ORDER BY q.modified_time DESC ");
