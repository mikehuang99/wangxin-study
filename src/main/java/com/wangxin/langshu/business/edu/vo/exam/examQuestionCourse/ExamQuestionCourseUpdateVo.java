...
public class ExamQuestionCourseUpdateVo  implements Serializable{
	
   
	/**
	 * 
	 */
	private static final long serialVersionUID = -8711359261337145080L;
	...
	private int bindType;//绑定类型(1课程、2章节、3课时)
}
