...
public class StudyProofSaveVo  implements Serializable{


	/**
	 * 
	 */
	private static final long serialVersionUID = 484074044214869708L;
    ...
    private ArrayList<StudyProofCourseSaveVo> studyProofCourseSaveVos;//学习记录课程列表
	
	@ApiModelProperty(value = "课程用户关系ID列表", required = false)
    private List<String> courseUserIds;//课程用户关系ID列表
	
	@ApiModelProperty(value = "用户编号", required = true)
    private String userNo;//该证明的用户编号
