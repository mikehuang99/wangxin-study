...
public class StudyCardSaveVo  implements Serializable{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 2841758221478966339L;
	...
	@ApiModelProperty(value = "学习卡产生数量", required = false)
	private int cardProduceNumber;//学习卡产生数量
	@ApiModelProperty(value = "学习卡卡号位数", required = false)
	private int cardNoBit;//学习卡卡号位数
	@ApiModelProperty(value = "学习卡密码位数", required = false)
	private int cardPswBit;//学习卡密码位数
