...
public class ExamQuestionUpdateVo  implements Serializable{
	
    /**
	 * 
	 */
	private static final long serialVersionUID = 8133953138312785524L;
	/**
	 * 
	 */
	...
	@ApiModelProperty(value = "难度，1到5，1最容易，5最难,6未知", required = false)
	...
	@ApiModelProperty(value = "customLabel 自定义标签，用于方便搜索", required = false)
